...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
         ...
         */
        /*private URL createUrl(String stringUrl) throw MalformedURLException{
        ...
        private URL createUrl(String stringUrl) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "Error creating URL from text", exception);
            }
            return url;
        }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if(responseCode==200) {
                    ...
                    Log.e(LOG_TAG,"Something went wrong with the request. Code != 200\n"+urlConnection.toString());
                    return jsonResponse;
                }
            } catch (IOException e) {
